...
type UserServiceClient interface {
	...
	GetUsersByIds(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error)
}
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/user.UserService/GetUsersByIds", opts...)
	if err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	GetUsersByIds(*UserListRequest, UserService_GetUsersByIdsServer) error
...
func (UnimplementedUserServiceServer) GetUsersByIds(*UserListRequest, UserService_GetUsersByIdsServer) error {
